                ...
                <div className="header-bar flex justify-between">
                    ...
                    <ul className="list-none mb-0 space-x-1">
                        <li className="dropdown inline-block relative">
                            ...
                            <div className={`dropdown-menu absolute end-0 m-0 mt-4 z-10 w-44 rounded-md overflow-hidden bg-white shadow ${user ? '' : 'hidden'}`} >
                                <ul className="py-2 text-start">
                                    <li>
                                        <Link to="/setting" className="flex items-center font-medium py-1 px-4 hover:text-indigo-600 "><AiOutlineSetting className="me-2"/>관리자 설정</Link>
                                    </li>
                                    <li>
                                        <Link to="/login" className="flex items-center font-medium py-1 px-4 hover:text-indigo-600"><IoMdLogOut className="me-2"/>로그아웃</Link>
                                    </li>
                                </ul>
                            </div>
                        </li>
